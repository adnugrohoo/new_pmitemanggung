...
class Pendonor_model extends CI_Model {
    ...
    function pendonor_list($start,$limit){
        $this->db->limit($limit,$start);
		$this->db->join('comgolongandarah', 'comgolongandarah.comGolonganDarahId = pendonor.comGolonganDarahId');
    	$this->db->order_by('pendonorId','DESC');
        $hasil = $this->db->get("pendonor");
        return $hasil->result();
    }
